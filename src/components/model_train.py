...
class ModelTrainer:
    ...
    def initate_model_trainer(self, train_array, test_array):
        try:
            logging.info("splitting test input data")
            ...
            model_report: dict = evaluate_model(Xtrain, ytrain, Xtest, ytest, models=models, param=params)
            ...
            r2_score_val = r2_score(ytest, predicted)
            
            return r2_score_val, best_model_name
            # print(model_report)
